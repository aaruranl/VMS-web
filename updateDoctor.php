...
if(count($_POST)>0) {
    mysqli_query($conn,"UPDATE doctors set firstName='" . $_POST['firstName'] . "',lastName='" . $_POST['lastName'] . "', nic='" . $_POST['nic'] . "',slmcNumber='" . $_POST['slmcNumber'] . "',ContactNumber='" . $_POST['ContactNumber'] . "',email='" . $_POST['email'] . "',qualification='" . $_POST['qualification'] . "',dob='" . $_POST['dob'] . "' , address='" . $_POST['address'] . "', gender='" . $_POST['gender'] . "' WHERE id='" . $_GET['id'] . "'");
    $message = "Record Modified Successfully"; 

}
    
    $result = mysqli_query($conn,"SELECT * FROM doctors WHERE id='" . $_GET['id'] . "'");
                    ...
                    <main>
                        ...
                        <div class="row py-3">
                            ...
                            <div class="col-md-7 col-lg-8">
                                <form class="needs-validation" action="" method="POST" onsubmit="return validateDoctor()" novalidate>
                                    <div class="row g-3">
                                        <div class="col-sm-6">
                                        ...
                                        <div class="col-sm-6 pt-3">
                                            <label for="slmcNumber" class="form-label">SLMC Reg No</label>
                                            <input type="text" class="form-control" id="slmcNumber" name="slmcNumber" placeholder=""  value="<?php echo $row['slmcNumber']; ?>" required>
                                            <div class="invalid-feedback">
                                                SLMC Reg No is required.
                                            </div>
                                            <div class="invalid" id="errorslmcNumber"></div>
                                        </div>
                                    ...
                                    <button class="w-100 btn btn-primary btn-lg" type="submit" value="submit" name="submit">Update Doctor</button>
                                </form>
                            </div>
                        </div>
                    </main>
