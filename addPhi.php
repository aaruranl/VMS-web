                    ...
                    <main>
                        ...
                        <div class="row py-3">
                            ...
                            <div class="col-md-7 col-lg-8">
                                <form class="needs-validation" action="createPhi.php" method="POST" onsubmit="return validatePhi()" novalidate>
                                    <div class="row g-3">
                                        <div class="col-sm-6">
                                    ...
                                    <button class="w-100 btn btn-primary btn-lg mt-4" type="submit" value="submit" name="submit">Add PHI</button>
                                </form>
                            </div>
                        </div>
                    </main>
