...
if(count($_POST)>0) {
    mysqli_query($conn,"UPDATE system set name='" . $_POST['name'] . "', nic='" . $_POST['nic'] . "', ContactNumber='" . $_POST['ContactNumber'] . "',email='" . $_POST['email'] . "',address='" . $_POST['address'] . "', username='" . $_POST['username'] . "', password='" . $_POST['password'] . "'  WHERE id='" . $_GET['id'] . "'");
    $message = "Record Modified Successfully"; 

}
    
    $result = mysqli_query($conn,"SELECT * FROM system WHERE id='" . $_GET['id'] . "'");
                    ...
                    <main>
                        ...
                        <div class="row py-3">
                            ...
                            <div class="col-md-7 col-lg-8">
                                <form class="needs-validation" action="" method="POST" onsubmit="return validateSystem()" novalidate>
                                    <div class="row g-3">
                                        <div class="col-sm-6">
                                        ...
                                        <div class="col-sm-6 pt-3">
                                            ...
                                            <input type="text" class="form-control" id="username" name="username" placeholder=""  value="<?php echo $row["username"]; ?>" required>
                                            <div class="invalid-feedback">
                                        ...
                                        <div class="col-sm-6 pt-3">
                                            ...
                                            <input type="password" class="form-control" id="password" name="password" placeholder="" value="<?php echo $row["password"]; ?>" required>
                                            <div class="invalid-feedback">
                                    ...
                                    <button class="w-100 btn btn-primary btn-lg" type="submit" value="submit" name="submit" >Update System Operator</button>
                                </form>
                            </div>
                        </div>
                    </main>
