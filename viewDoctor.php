                    ...
                    <table class="table table-dark">
                        ...
                        <tbody>
                            ...
                            <tr class="<?php if(isset($classname)) echo $classname;?>">
                                ...
                                <td><a href="updateDoctor.php?id=<?php echo $row["id"]; ?>" class="btn btn-warning text-light">Update</a></td>
                                <td><a href="deleteDoctor.php?id=<?php echo $row["id"]; ?>" class="btn btn-danger text-light">Delete</a></td>
                            </tr>
                            <?php $i++; } ?>
                        </tbody>
