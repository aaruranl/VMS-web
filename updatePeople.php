...
if(count($_POST)>0) {
    mysqli_query($conn,"UPDATE phis set name='" . $_POST['name'] . "', nic='" . $_POST['nic'] . "',ContactNumber='" . $_POST['ContactNumber'] . "',email='" . $_POST['email'] . "',dob='" . $_POST['dob'] . "' , address='" . $_POST['address'] . "', gender='" . $_POST['gender'] . "',province='" . $_POST['province'] . "',district='" . $_POST['district'] . "',ds='" . $_POST['ds'] . "' WHERE id='" . $_GET['id'] . "'");
    $message = "Record Modified Successfully"; 
}
    
    $result = mysqli_query($conn,"SELECT * FROM phis WHERE id='" . $_GET['id'] . "'");
        ...
        <div id="content">
            ...
            <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Update People</li>
                </ol>
            </nav>
                    ...
                    <main>
                        ...
                        <div class="row py-3">
                            ...
                            <div class="col-md-7 col-lg-8">
                                <form class="needs-validation" action="" method="POST" onsubmit="return validatePeople()" novalidate>
                                    <div class="row g-3">
                                        ...
                                        <div class="col-12 pt-3">
                                            ...
                                            <textarea type="text" class="form-control" id="address" name="address" value="<?php echo $row['address']; ?>" required></textarea>
                                            <div class="invalid-feedback">
                                                Address is required.
                                            </div>
                                        ...
                                        <div class="col-sm-4 pt-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="district" id="district" required>
                                                    <option value="<?php echo $row['district']; ?>"><?php echo $row['address']; ?></option>
                                        ...
                                        <div class="col-sm-4 pt-3">
                                            <div class="form-group">
                                                ...
                                                <select class="form-control" name="ds" id="ds" required>
                                                    <option value="<?php echo $row['ds']; ?>"><?php echo $row['address']; ?></option>
                                                    <option value="Colombo">Colombo</option>
                                    ...
                                    <button class="w-100 btn btn-primary btn-lg mt-4" type="submit" value="submit" name="submit">Update People</button>
                                </form>
                            </div>
                        </div>
                    </main>
